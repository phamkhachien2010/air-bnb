          ...
          <div class="left-side">
            ...
            <nav id="navigation" class="style-1">
              <ul id="responsive">
                ...
                <li>
                  <a class="current" href="#">User Panel</a>
                  <ul>
          ...
          <ul data-submenu-title="Main">
            ...
            <li>
              <a href="dashboard-messages.html"
                ...
                <span class="nav-tag messages">2</span></a
              >
            </li>
            <li>
              <a href="dashboard-bookings.html"
            ...
            <div class="dashboard-list-box with-icons margin-top-20">
              ...
              <ul>
                <li>
                  ...
                  <strong><a href="#">Hotel Govendor</a></strong> has been
                  approved!
                ...
                <li>
                  <i class="list-box-icon sl sl-icon-star"></i> Kathy Brown left
                  a review
                ...
                <li>
                  <i class="list-box-icon sl sl-icon-heart"></i> Someone
                  bookmarked your
                  <strong><a href="#">Burger House</a></strong> listing!
                  <a href="#" class="close-list-item"
                    ><i class="fa fa-close"></i
                  ></a>
                </li>
                ...
                <li>
                  <i class="list-box-icon sl sl-icon-star"></i> Jack Perry left
                  a review
